...
export class PatientService {  
  ...
  private patientsSignal \= signal\<Patient\[\]\>(MOCK\_PATIENTS);  
...
*Once the Java 25 backend is ready, the service will be swapped to use Angular's HttpClient with toSignal() or standard observables mapping to the backend REST endpoints.*
