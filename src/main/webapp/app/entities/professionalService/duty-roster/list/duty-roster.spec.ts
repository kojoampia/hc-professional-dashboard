...
describe.skip('DutyRoster Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '401a8b55-3dcb-46fc-bb91-cbfc48b18166' }], {
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.dutyRostersParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
