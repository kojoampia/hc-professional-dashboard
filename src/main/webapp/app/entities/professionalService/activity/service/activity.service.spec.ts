...
describe('Activity Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Activity', () => {
      ...
      service.create(activity).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Activity', () => {
      ...
      service.update(activity).subscribe(resp => (expectedResult = resp));
    ...
    describe('addActivityToCollectionIfMissing', () => {
      it('should add a Activity to an empty array', () => {
        ...
        expect(expectedResult).toEqual([activity]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([activity, activity2]);
      });
    ...
    describe('compareActivity', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' };
        const entity2 = { id: 'fee48f48-5276-4201-a597-a956732a5cc2' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' };
        const entity2 = { id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' };
