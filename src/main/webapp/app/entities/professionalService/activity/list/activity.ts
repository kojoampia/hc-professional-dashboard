...
import { ActivityDeleteDialogComponent } from '../delete/activity-delete-dialog';
...
export class ActivityComponent implements OnInit {
  ...
  trackId = (item: IActivity): string => this.activityService.getActivityIdentifier(item);
  ...
  delete(activity: IActivity): void {
    const dialogRef = this.dialog.open(ActivityDeleteDialogComponent, { width: '32rem', disableClose: true });
