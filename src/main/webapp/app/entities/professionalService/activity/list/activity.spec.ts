...
describe.skip('Activity Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' }], {
    ...
    expect(comp.activities()[0]).toEqual(expect.objectContaining({ id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' }));
  });

  describe('trackId', () => {
    it('should forward to activityService', () => {
      const entity = { id: '1e3cd754-7fbf-4a55-b6f2-b6b9e9c31901' };
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.activitiesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
