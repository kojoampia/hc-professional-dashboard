...
import { ActivityLogEntryDeleteDialogComponent } from './activity-log-entry-delete-dialog';

describe('ActivityLogEntry Management Delete Component', () => {
  let comp: ActivityLogEntryDeleteDialogComponent;
  let fixture: ComponentFixture<ActivityLogEntryDeleteDialogComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ActivityLogEntryDeleteDialogComponent);
