...
import { sampleWithRequiredData } from '../recommendation.test-samples';
...
describe.skip('Recommendation Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'd9c30eb8-00d3-4951-89c3-922dfba6713f' }], {
    ...
    expect(comp.recommendations()[0]).toEqual(expect.objectContaining({ id: 'd9c30eb8-00d3-4951-89c3-922dfba6713f' }));
  });
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.recommendationsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
