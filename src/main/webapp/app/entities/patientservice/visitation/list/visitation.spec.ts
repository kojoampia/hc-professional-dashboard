...
import { sampleWithRequiredData } from '../visitation.test-samples';
...
describe.skip('Visitation Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '9b4f6bb1-0c86-45a9-a55b-dd48e1bddef9' }], {
    ...
    expect(comp.visitations()[0]).toEqual(expect.objectContaining({ id: '9b4f6bb1-0c86-45a9-a55b-dd48e1bddef9' }));
  });

  describe('trackId', () => {
    it('should forward to visitationService', () => {
      const entity = { id: '9b4f6bb1-0c86-45a9-a55b-dd48e1bddef9' };
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.visitationsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
