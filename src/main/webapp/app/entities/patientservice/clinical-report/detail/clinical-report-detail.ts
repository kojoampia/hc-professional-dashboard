...
@Component({
  ...
  selector: 'hpd-clinical-report-detail',
  templateUrl: './clinical-report-detail.html',
...
export class ClinicalReportDetailComponent {
  readonly clinicalReport = input<IClinicalReport | null>(null);
