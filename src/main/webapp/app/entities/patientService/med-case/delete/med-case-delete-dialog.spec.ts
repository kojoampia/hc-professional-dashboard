...
import { MedCaseDeleteDialog } from './med-case-delete-dialog';

describe('MedCase Management Delete Component', () => {
  let comp: MedCaseDeleteDialog;
  let fixture: ComponentFixture<MedCaseDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MedCaseDeleteDialog);
