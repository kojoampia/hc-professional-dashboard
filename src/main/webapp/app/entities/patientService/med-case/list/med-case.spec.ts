...
import { MedCaseComponent } from './med-case';

jest.useFakeTimers();

describe('MedCase Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: MedCaseComponent;
  let fixture: ComponentFixture<MedCaseComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MedCaseComponent);
  ...
  describe('trackId', () => {
    it('should forward to medCaseService', () => {
      ...
      jest.spyOn(service, 'getMedCaseIdentifier');
