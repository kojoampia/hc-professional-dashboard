...
import healthConnectProfessionalResolve from './health-connect-professional-routing-resolve.service';

describe('HealthConnectProfessional routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IHealthConnectProfessional returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          healthConnectProfessionalResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(healthConnectProfessionalResolve(mockActivatedRouteSnapshot))).rejects.toThrow(
