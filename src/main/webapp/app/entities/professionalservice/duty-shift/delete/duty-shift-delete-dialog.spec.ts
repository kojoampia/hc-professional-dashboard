...
import { DutyShiftDeleteDialogComponent } from './duty-shift-delete-dialog';

describe('DutyShift Management Delete Component', () => {
  let comp: DutyShiftDeleteDialogComponent;
  let fixture: ComponentFixture<DutyShiftDeleteDialogComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DutyShiftDeleteDialogComponent);
