...
| 12. Ongoing compliance                               | Credentialing reviewer and scheduler     | MonitPersonalDocumente/document expiry (from `IDocument.expiryDate`), authority changes, roster changes, deactivation.                                            | Expiring/revoked credentials trigger review, restriction, or deactivation.                                             | Scheduled expiry sweep + alerts; access revocation and audit history tested end-to-end.                                                    |
